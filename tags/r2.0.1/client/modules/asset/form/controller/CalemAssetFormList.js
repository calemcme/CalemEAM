 ...
 * CalemAssetFormList
 */
function CalemAssetFormList(parent, formId, data) {
	if (arguments.length==0) return;
	CalemFormList.call(this, parent, formId, data);
}

CalemAssetFormList.prototype = new CalemFormList;
CalemAssetFormList.prototype.constructor = CalemAssetFormList;

CalemAssetFormList.prototype.toString = function() { return "CalemAssetFormList";}

/**
 * Business APIs
 */
CalemAssetFormList.prototype._getFormNewId =
function(evt) {
 ...
 */
CalemAssetFormList.prototype._onOpen =
function(evt) {
	...
	this._openForm('CalemAssetFormMdTab', data);
} 

/**
 * Deletion must be handled specially
 */
CalemAssetFormList.prototype.onDelete =
function(evt) {
