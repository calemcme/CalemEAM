 ...
 * List views
 */
CalemViewDef['CalemVersionUpgradeLogViewList']={
	CalemViewInfo: {
		id: 'CalemVersionUpgradeLogViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'version_upgrade_log', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
					layout: ['CalemTbOpen', 'CalemTbDelete', 'sep', 'CalemTbDataRefresh', 'sep2', 'CalemTbCustomize'],
					list: [
					{ CalemButtonInfo: {
						 id: 'CalemTbOpen', 
						 customInfo: {
