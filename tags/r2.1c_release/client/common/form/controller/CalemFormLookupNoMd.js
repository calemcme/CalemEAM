 ...
 * 
 */
function CalemFormLookupNoMd(parent, formId, data) {
	if (arguments.length==0) return;
	CalemFormLookup.call(this, parent, formId, data);
}

CalemFormLookupNoMd.prototype = new CalemFormLookup;
CalemFormLookupNoMd.prototype.constructor = CalemFormLookupNoMd;

CalemFormLookupNoMd.prototype.toString = function() { return "CalemFormLookupNoMd"; }

/**
 * Setting up master detail relation ship.
 */
CalemFormLookupNoMd.prototype._createDataModel =
function(data) {
