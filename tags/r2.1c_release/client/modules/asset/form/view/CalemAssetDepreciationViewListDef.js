 ...
 * List views
 */
CalemViewDef['CalemAssetDepreciationViewList']={
	CalemViewInfo: {
		id: 'CalemAssetDepreciationViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'asset_depreciation', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
			  ...
			  CalemDataGridInfo: {
				listInfo: {
			  	   CalemListInfo: {
			  			noMaximize: true,
			  			colList: [
			  			   {CalemCol: {id: 'start_date', width: 130}},
			  			   {CalemCol: {id: 'end_date', width: 130}},
			  			   {CalemCol: {id: 'end_value', width: 130}},
