 ...
 * List views
 */
CalemViewDef['CalemWoPartViewList']={
	CalemViewInfo: {
		id: 'CalemWoPartViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'wo_part', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
					layout: ['CalemTbWoPartNew', 'CalemTbWoPartAdd', 'CalemTbWoPartReturn', 'sep', 'CalemTbOpen', 'CalemTbDelete', 'sep2','CalemTbCustomize'],
					list: [
				   //New
					{ CalemButtonInfo: {id: 'CalemTbWoPartNew'}},
