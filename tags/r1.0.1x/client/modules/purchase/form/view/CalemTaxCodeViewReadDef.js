 ...
 * Budget views
 */
CalemViewDef['CalemTaxCodeViewRead']={
	CalemViewInfo: {
		id: 'CalemTaxCodeViewRead',
		type: 'CalemView',
		layout: {
		 CalemLayoutInfo: {
		...
		itemMap : {
			...
			toolbar: {
				CalemToolBarInfo: {
					type: 'CalemToolBar',
					layout: ['CalemTbNew', 'CalemTbEdit', 'CalemTbDelete', 'sep', 'CalemTbPrev', 'CalemTbNext','CalemTbBudgetUpdate', 'sep2', 'CalemTbCustomize'],
					list: [
