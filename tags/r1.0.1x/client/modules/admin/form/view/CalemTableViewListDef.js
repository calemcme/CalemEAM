 ...
 * AclGroup views
 */
CalemViewDef['CalemTableViewList']={
	CalemViewInfo: {
		id: 'CalemTableViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {CalemLabelInfo: {id: 'vt_table_list', className: 'CalemEditCaption'}},
			
			toolbar: {
				CalemToolBarInfo: {
					layout: ['CalemTbTableDesign', 'sep', 'CalemTbCancel'],
					list: [
