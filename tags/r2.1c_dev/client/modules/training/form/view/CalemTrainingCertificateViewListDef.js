 ...
 * List views
 */
CalemViewDef['CalemTrainingCertificateViewList']={
	CalemViewInfo: {
		id: 'CalemTrainingCertificateViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'training_certificate', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
			  ...
			  CalemDataGridInfo: {
				listInfo: {
			  	   CalemListInfo: {
			  			noMaximize: true,
			  			colList: [
			  			   {CalemCol: {id: 'certificate', width: 150}}
			  			]	 
			  		} 		
		      }
			}
