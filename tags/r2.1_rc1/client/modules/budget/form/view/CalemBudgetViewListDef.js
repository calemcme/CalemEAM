 ...
 * Budget views
 */
CalemViewDef['CalemBudgetViewList']={
	CalemViewInfo: {
		id: 'CalemBudgetViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'budget', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
					layout: ['CalemTbNew', 'CalemTbOpen', 'CalemTbDelete', 'sep', 'CalemTbPrint', 'sep2', 'CalemTbCustomize'],
					list: [
				   //New
			  ...
			  CalemDataGridInfo: {
				listInfo: {
			  	   CalemListInfo: {
			  			noMaximize: true,
			  			colList: [
			  			   {CalemCol: {id: 'budget', width: 200}},
			  			   {CalemCol: {id: 'start_date', width: 110}},
			  			   {CalemCol: {id: 'end_date', width: 110}},
			  			   {CalemCol: {id: 'costcode_id', width: 110}},
			  			   {CalemCol: {id: 'budgeted', width: 150}},
			  			   {CalemCol: {id: 'app', width: 150}},
			  			   {CalemCol: {id: 'accounting', width: 150}}
			  			]	 
			  		} 		
		      }
			}
