 ...
 * List views
 */
CalemViewDef['CalemWoSchedLaborViewList']={
	CalemViewInfo: {
		id: 'CalemWoSchedLaborViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'wo_sched_labor', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
