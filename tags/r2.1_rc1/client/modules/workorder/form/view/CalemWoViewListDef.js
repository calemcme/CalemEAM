...
CalemViewDef['CalemWoViewList']={
	CalemViewInfo: {
		...
		itemMap : {
			...
			toolbar: {
				CalemToolBarInfo: {
					layout: ['CalemTbNew', 'CalemTbOpen', 'CalemTbDelete', 'CalemTbDataRefresh', 'sep', 'CalemTbPrint', 'sep2', 'CalemTbSearch', 'CalemTbSearchClear', 'sep3', 'CalemTbCustomize'],
					list: [
				   //New
			  ...
			  CalemDataGridInfo: {
				listInfo: {
			  	   CalemListInfo: {
			  			noMaximize: true,
			  			colList: [
			  			   {CalemCol: {id: 'wo_no', width: 130}},
			  			   {CalemCol: {id: 'asset_id', width: 130}},
			  			   {CalemCol: {id: 'pm_id', width: 130}},
			  			   {CalemCol: {id: 'sched_finish_time', width: 160}},
			  			   {CalemCol: {id: 'description', width: 160}}
			  			]	 
			  		} 		
		      }
			}
