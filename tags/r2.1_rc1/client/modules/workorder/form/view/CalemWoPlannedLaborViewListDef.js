 ...
 * List views
 */
CalemViewDef['CalemWoPlannedLaborViewList']={
	CalemViewInfo: {
		id: 'CalemWoPlannedLaborViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'wo_planned_labor', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
			  ...
			  CalemDataGridInfo: {
				listInfo: {
			  	   CalemListInfo: {
			  			noMaximize: true,
			  			colList: [
			  			   {CalemCol: {id: 'craft_id', width: 300}}
			  			]	 
			  		} 		
		      }
			}
