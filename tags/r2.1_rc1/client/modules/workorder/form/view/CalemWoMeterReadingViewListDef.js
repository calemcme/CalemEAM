 ...
 * List views
 */
CalemViewDef['CalemWoMeterReadingViewList']={
	CalemViewInfo: {
		id: 'CalemWoMeterReadingViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'asset_transaction', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
					layout: ['CalemTbOpen', 'CalemTbDelete', 'sep','CalemTbCustomize'],
					list: [
