 ...
 * List views
 */
CalemViewDef['CalemDocAttachmentViewList']={
	CalemViewInfo: {
		id: 'CalemDocAttachmentViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'doc_attachment', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
			  ...
			  CalemDataGridInfo: {
				listInfo: {
			  	   CalemListInfo: {
			  			noMaximize: true,
			  			colList: [
			  			   {CalemCol: {id: 'upload_id', width: 300}}
			  			]	 
			  		} 		
		      }
			}
