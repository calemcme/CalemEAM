 ...
 * List views
 */
CalemViewDef['CalemContractContactViewList']={
	CalemViewInfo: {
		id: 'CalemContractContactViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'contract_contact', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
			  ...
			  CalemDataGridInfo: {
				listInfo: {
			  	   CalemListInfo: {
			  			noMaximize: true,
			  			colList: [
			  			   {CalemCol: {id: 'contact_id', width: 300}}
			  			]	 
			  		} 		
		      }
			}
