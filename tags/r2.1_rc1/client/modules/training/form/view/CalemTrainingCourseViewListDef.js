 ...
 * List views
 */
CalemViewDef['CalemTrainingCourseViewList']={
	CalemViewInfo: {
		id: 'CalemTrainingCourseViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'training_course', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
