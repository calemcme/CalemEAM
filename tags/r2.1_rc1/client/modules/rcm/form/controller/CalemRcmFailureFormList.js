...
/**
 * CalemRcmFailureFormList
 */
function CalemRcmFailureFormList(parent, formId, data) {
	if (arguments.length==0) return;
	CalemFormList.call(this, parent, formId, data);
}

CalemRcmFailureFormList.prototype = new CalemFormList;
CalemRcmFailureFormList.prototype.constructor = CalemRcmFailureFormList;

CalemRcmFailureFormList.prototype.toString = function() { return "CalemRcmFailureFormList";}

/**
 * Business APIs
 */
CalemRcmFailureFormList.prototype._getFormNewId =
function(evt) {
 ...
 */
CalemRcmFailureFormList.prototype._onOpen =
function(evt) {
	...
	this._openForm('CalemRcmFailureFormMdTab', data);
} 

/**
 * Deletion must be handled specially
 */
CalemRcmFailureFormList.prototype.onDelete =
function(evt) {
