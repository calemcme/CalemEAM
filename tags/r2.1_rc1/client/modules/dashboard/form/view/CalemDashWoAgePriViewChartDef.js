...
CalemViewDef['CalemDashWoAgePriViewChart']={
	CalemViewInfo: {
		id: 'CalemDashWoAgePriViewChart',
		type: 'CalemView',
		layout: {
		 CalemLayoutInfo: {
		...
		itemMap : {
			...
			'lb_caption': {
				CalemLabelInfo: {id: 'dash_wo_age_pri', className: 'CalemEditCaption'}
			},
			'chart_info': {
				CalemChartColumnInfo: {id: 'dash_wo_age_pri'}
			}
	}
 } //ItemMap	
}
