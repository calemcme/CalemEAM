 ...
 * CalemPoFormList
 */
function CalemPoFormList(parent, formId, data) {
	if (arguments.length==0) return;
	CalemFormList.call(this, parent, formId, data);
}

CalemPoFormList.prototype = new CalemFormList;
CalemPoFormList.prototype.constructor = CalemPoFormList;

CalemPoFormList.prototype.toString = function() { return "CalemPoFormList";}

/**
 * Business APIs
 */
CalemPoFormList.prototype._getFormNewId =
function(evt) {
 ...
 */
CalemPoFormList.prototype._onOpen =
function(evt) {
 ...
 */
CalemPoFormList.prototype.onDelete =
function(evt) {
...
//Report
CalemPoFormList.prototype.getReportId =
function() {
