 ...
 * Lookup views
 */
CalemViewDef['CalemUomMapViewLookup']={
	CalemViewInfo: {
		id: 'CalemUomMapViewLookup',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			...
			toolbar: {
				CalemToolBarInfo: {
					layout: ['CalemTbSelect', 'CalemTbCancel', 'CalemTbNew', 'sep', 'CalemTbSearch', 'CalemTbSearchClear', 'sep3', 'CalemTbCustomize'],
					list: [
				   //New
