 ...
 * List views
 */
CalemViewDef['CalemAssetCommentViewList']={
	CalemViewInfo: {
		id: 'CalemAssetCommentViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'asset_comment', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
				...
				listInfo: {
			  	   CalemListInfo: {
			  			...
			  			colList: [
			  			   ...
			  			   {CalemCol: {id: 'modified_time', width: 130}}
			  			]	 
			  		} 		
		      }
			}
