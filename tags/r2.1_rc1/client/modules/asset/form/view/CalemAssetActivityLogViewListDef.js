 ...
 * List views
 */
CalemViewDef['CalemAssetActivityLogViewList']={
	CalemViewInfo: {
		id: 'CalemAssetActivityLogViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'asset_view_activity_log', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
