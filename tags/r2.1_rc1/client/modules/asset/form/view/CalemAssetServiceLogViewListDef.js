 ...
 * List views
 */
CalemViewDef['CalemAssetServiceLogViewList']={
	CalemViewInfo: {
		id: 'CalemAssetServiceLogViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'asset_service_log', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
			  ...
			  CalemDataGridInfo: {
				listInfo: {
			  	   CalemListInfo: {
			  			noMaximize: true,
			  			colList: [
			  			   {CalemCol: {id: 'to_status_id', width: 300}}
			  			]	 
			  		} 		
		      }
			}
