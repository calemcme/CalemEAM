 ...
 * CalemAssetFormMdTab
 */
function CalemAssetFormMdTab(parent, formId, data) {
	if (arguments.length==0) return;
	CalemFormMdTab.call(this, parent, formId, data);
}

CalemAssetFormMdTab.prototype = new CalemFormMdTab;
CalemAssetFormMdTab.prototype.constructor = CalemAssetFormMdTab;

CalemAssetFormMdTab.prototype.toString = function() { return "CalemAssetFormMdTab";}
