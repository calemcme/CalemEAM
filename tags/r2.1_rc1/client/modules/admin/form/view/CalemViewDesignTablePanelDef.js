 ...
 * Budget views
 */
CalemViewDef['CalemViewDesignTablePanel']={
	CalemViewInfo: {
		id: 'CalemViewDesignTablePanel',
		type: 'CalemView',
		layout: {
		 CalemLayoutInfo: {
			...
			rows: [
					{CalemTrInfo: {cols: ['lb_table_design']}},
		...
		itemMap : {
			...
			'lb_table_design': {
				CalemDesignLabelInfo: {id: 'table_design', className: 'CalemEditCaption'}
			},
			'tree' : {
