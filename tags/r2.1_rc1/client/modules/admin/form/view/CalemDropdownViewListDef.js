 ...
 * AclGroup views
 */
CalemViewDef['CalemDropdownViewList']={
	CalemViewInfo: {
		id: 'CalemDropdownViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {CalemLabelInfo: {id: 'vt_dropdown_list', className: 'CalemEditCaption'}},
			
			toolbar: {
				CalemToolBarInfo: {
					layout: ['CalemTbDropdownDesign', 'sep', 'CalemTbCancel'],
					list: [
			  ...
			  CalemDataGridInfo: {
				listInfo: {
			  	   CalemListInfo: {
			  			noMaximize: true,
			  			colList: [
			  			   {CalemCol: {id: 'id', width: 200}},
			  			   {CalemCol: {id: 'table_name', width: 200}},
			  			   {CalemCol: {id: 'module', width: 150}}
			  			]	 
			  		} 		
		      }
			}
