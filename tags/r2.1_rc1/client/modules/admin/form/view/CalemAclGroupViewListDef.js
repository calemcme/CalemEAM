 ...
 * AclGroup views
 */
CalemViewDef['CalemAclGroupViewList']={
	CalemViewInfo: {
		id: 'CalemAclGroupViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'acl_group', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
					layout: ['CalemTbNew', 'CalemTbOpen', 'CalemTbDelete', 'sep', 'CalemTbPrint', 'sep2', 'CalemTbSearch', 'CalemTbSearchClear', 'sep3', 'CalemTbCustomize'],
					list: [
				   //New
					...
					{CalemSeparator: {id: 'sep4', className: 'CalemToolBarSeparator'}},
			  ...
			  CalemDataGridInfo: {
				listInfo: {
			  	   CalemListInfo: {
			  			noMaximize: true,
			  			colList: [
			  			   {CalemCol: {id: 'acl_group', width: 130}},
			  			   {CalemCol: {id: 'parent_group_id', width: 130}},
			  			   {CalemCol: {id: 'note', width: 200}}
			  			]	 
			  		} 		
		      }
			}
