...
function CalemModel(dummy) {
	if (arguments.length==0) return;
	this._eventMgr = new AjxEventMgr();
} 

CalemModel.prototype.toString = 
function() {
	return "CalemModel";
}

CalemModel.prototype.addListener = 
function(eventType, listener) {
	return this._eventMgr.addListener(eventType, listener);
}

CalemModel.prototype.removeListener = 
function(eventType, listener) {
	return this._eventMgr.removeListener(eventType, listener);    	
}

CalemModel.prototype.notifyListeners = 
