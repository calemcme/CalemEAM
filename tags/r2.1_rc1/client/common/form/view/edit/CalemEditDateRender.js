...
/**
 * CalemEditDateRender
 * Render Date edit field.
 *  
 */
function CalemEditDateRender(parent, id, fldInfo, controller) {
	if (arguments.length==0) return;
	CalemEditRender.call(this, parent, id, fldInfo, controller);
}

CalemEditDateRender.prototype=new CalemEditRender;
CalemEditDateRender.prototype.constructor=CalemEditDateRender;

CalemEditDateRender.prototype.toString = function() { return "CalemEditDateRender"; }

CalemEditDateRender.prototype.render =
