...
CalemViewDef['CalemInsCitationViewRead']={
	CalemViewInfo: {
		id: 'CalemInsCitationViewRead',
		type: 'CalemView',
		layout: {
		 CalemLayoutInfo: {
		...
		itemMap : {
			...
			toolbar: {
				CalemToolBarInfo: {
					type: 'CalemToolBar',
					layout: ['CalemTbNew', 'CalemTbEdit', 'CalemTbDelete', 'CalemTbPrev', 'CalemTbNext', 'sep', 'CalemTbCancel', 'CalemTbDataRefresh', 'sep2', 'CalemTbCustomize'],
					list: [
			...
			'lb_caption': {
				CalemLabelInfo: {id: 'ins_citation', className: 'CalemEditCaption'}
			},
			'err': {
