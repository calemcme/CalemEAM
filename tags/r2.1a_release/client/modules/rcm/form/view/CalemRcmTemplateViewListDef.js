 ...
 * List views
 */
CalemViewDef['CalemRcmTemplateViewList']={
	CalemViewInfo: {
		id: 'CalemRcmTemplateViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'rcm_template', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
			  ...
			  CalemDataGridInfo: {
				listInfo: {
			  	   CalemListInfo: {
			  			noMaximize: true,
			  			colList: [
			  			   {CalemCol: {id: 'template', width: 130}}
			  			]	 
			  		} 		
		      }
			}
