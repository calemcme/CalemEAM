...
CalemViewDef['CalemDashWoOrigDayViewChart']={
	CalemViewInfo: {
		id: 'CalemDashWoOrigDayViewChart',
		type: 'CalemView',
		layout: {
		 CalemLayoutInfo: {
		...
		itemMap : {
			...
			'lb_caption': {
				CalemLabelInfo: {id: 'dash_wo_orig_day', className: 'CalemEditCaption'}
			},
			'chart_info': {
				CalemChartLineInfo: {id: 'dash_wo_orig_day'}
			}
	}
 } //ItemMap	
}
