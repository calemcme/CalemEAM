 ...
 */
class WoSeqTest extends PHPUnit2_Framework_TestCase {
	
	public function testWoSeq() {
		$woBo=new CalemWoBo();
		$wo1=$woBo->getNextWoNo();
		$wo2=$woBo->getNextWoNo();
		if (!isset($_ENV['CALEM_BATCH_TEST'])) {
			echo "wo1 and 2: " . $wo1 . ", " . $wo2 . "<br>"; 
		}
		$this->assertTrue($wo2==$wo1+1);
	}	
}
