 ...
 */
class InTranProjectToolTest extends PHPUnit2_Framework_TestCase {
	...
	public function _testCheckout($tran) {
		...
		//Verify project cost not adjusted.
	}
	...
	public function testAvgCheckout() {
		...
		$tran=array(
			...
			'location_id'=>'10001',
			'qty'=>2,
			'checkout_type_id'=>'ict_project',
			'checkout_to_id'=>'project-001',
			'note'=>'test1',
	...
	public function testAvgReturn() {
		...
		//Run return
		$inTranDbo=CalemFactory::getDbo('in_tran');
		$rows=$inTranDbo->fetchBySqlParam('select id from in_tran where in_id=? and checkout_to_id=?', array($this->inAr['id'], 'project-001'));
