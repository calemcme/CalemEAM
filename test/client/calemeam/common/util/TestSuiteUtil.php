...
<head>
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        //DB Query test suite
        function utilSuite(url) {
        		var result = new top.jsUnitTestSuite(); 
        		result.addTestPage(url+"testTextUtil.php?localrun=0");
        		return result;
        }

        function suite() {
            var newsuite = new top.jsUnitTestSuite();
            var url='<?php print $calemRootUrl ?>/test/client/calemeam/common/util/';
            newsuite.addTestSuite(utilSuite(url));
            return newsuite;
        }
    </script>
</head>
