...
<head>
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        //asset module
        function assetModule(url) {
        		var result = new top.jsUnitTestSuite();
        		result.addTestPage(url+"asset/testAssetPartRecord.php?localrun=0");
            return result;
        }
        
        function suite() {
            var newsuite = new top.jsUnitTestSuite();
            var url='<?php print $calemRootUrl ?>/test/client/calemeam/modules/';
            newsuite.addTestSuite(assetModule(url));
            return newsuite;
        }
    </script>
</head>
