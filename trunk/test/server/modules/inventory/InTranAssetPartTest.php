 ...
 */
class InTranAssetPartTest extends PHPUnit2_Framework_TestCase {
	...
	public function _testCheckout($tran) {
		...
		//Verify transaction
		$this->assertTrue($rtn['qty_available']==$rtn['qty']);
		//Verify at in level
	...
	public function _testReturn($tran, $tranReturn) {
		...
		$this->assertTrue($assetRow['maint_material_cost']==$this->assetAr['maint_material_cost']+
		                    ($tran['qty']-$tranReturn['qty'])*$inRow['avg_unit_cost']);
