 ...
 */
class InTranMoveToolTest extends PHPUnit2_Framework_TestCase {
	...
	public function _testMove($tran) {
		...
		$this->assertTrue($srcRow['qty']==$this->inStockAr1['qty']-$tran['qty']);
		//Verify moved to
		...
		$this->assertTrue($destRow['qty']==$this->inStockAr2['qty']+$tran['qty']);
