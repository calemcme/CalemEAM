 ...
 */
class InTranCheckinPartTest extends PHPUnit2_Framework_TestCase {
	...
	public function _testCheckin($tran) {
		$inTranBo=new CalemInTranBo();
		$rtn=$inTranBo->checkin($tran);		
	...
	//Checkout to asset	 
	public function testAvgCheckin() {
		$this->cleanupData();
		$this->setupData();
		$tran=$this->receiveTran;
		$tran['in_id']=$this->inAr['id'];
		//Run checkout
		$this->_testCheckin($tran);		
		//cleanup
		$this->cleanupData();                 
	}
}
