...
<head>
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        function desktopSuite(url) {
            var result = new top.jsUnitTestSuite();
            result.addTestPage(url+"testCalemLoginAndOut.php?localrun=0");
            return result;
        }

        function suite() {
            var newsuite = new top.jsUnitTestSuite();
            var url='<?php print $calemRootUrl ?>/test/client/calemeam/common/desktop/';
            newsuite.addTestSuite(desktopSuite(url));
            return newsuite;
        }
    </script>
</head>
