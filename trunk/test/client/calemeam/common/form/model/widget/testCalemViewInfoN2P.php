...
<head>
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        function testCalemViewInfo() {
            testCalemViewInfoN2P();
        	//debug("<b>testCalemViewInfo in 3 sec.</b>");
        	//setTimeout("testCalemViewInfoAll()", 3000);
        }
        
        function testCalemViewInfoN2P() {
        	  debug("<b>testCalemViewInfo G to M ...</b>");
        ...
        function validateOneView() {
        	 ...
        	 validateViewInfo('CalemProjectViewList');
        }
        ...
        function validateViewInfo(id) {
        	 ...
        	 debug('layout len='+tbInfo.getLayout().length);
        	 debug('list len='+tbInfo.getList().length);
