...
<head>
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        //Test errorInfo
        function testCalemErrorInfo() {
        	   debug("<b>testCalemErrorInfo</b>");
        		var ei={errorInfo: {table: 'budget_title', 'id': 'CalemDboDuplicateKeyException', nativeError: 'NativeError', param: null}};
        		errorHandler=eval(['new ', ei.errorInfo.id, '(ei.errorInfo.table, ei.errorInfo)'].join(''));
        		this.assertTrue(errorHandler.getMessage().indexOf('duplicated')!==false);
        		this.assertTrue(errorHandler.getMessage().indexOf("NativeError")!==false);
        		debug("errorMsg="+errorHandler.getMessage());
