...
$_CALEM_gen_data = array(
	'title'=>' === Generating woStatusLog ===' . "<br>",
   'regenerate'=>true,
   'overwrite'=>false,
   'dataList'=>array(
      array(
   	...
   	array(
   		...
   		'file_dst'=>array(
   			...
   			'pattern'=>'CalemWoStatusLogView')
   	)
   ),
   'file_patterns'=>array(
   	'CalemPmLabor'=>'CalemWoStatusLog',
   	'pm_labor' => 'wo_status_log',
   	'craft_id'=>'to_status_id'   
   )
);
