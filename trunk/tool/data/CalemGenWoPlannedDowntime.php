...
$_CALEM_gen_data = array(
	'title'=>' === Generating WoPlannedDowntime ===' . "<br>",
   'regenerate'=>true,
   'overwrite'=>false,
   'dataList'=>array(
      array(
   		...
   		'file_dst'=>array(
   			...
   			'pattern'=>'CalemWoPlannedDowntimeForm')
   	),
   	array(
			'file_src'=>array(
   		...
   		'file_dst'=>array(
   			...
   			'pattern'=>'CalemWoPlannedDowntimeView')
   	)
   ),
   'file_patterns'=>array(
   	'CalemPmLabor'=>'CalemWoPlannedDowntime',
   	'pm_labor' => 'wo_planned_downtime',
   	'craft_id'=>'hours'   
   )
);
