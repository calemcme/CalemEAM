 ...
 */
function CalemWoToolAddFormEdit(parent, formId, data) {
	if (arguments.length==0) return;
	CalemWoPartAddFormEdit.call(this, parent, formId, data);
}

CalemWoToolAddFormEdit.prototype = new CalemWoPartAddFormEdit;
