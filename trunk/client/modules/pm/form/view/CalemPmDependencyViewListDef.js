 ...
 * List views
 */
CalemViewDef['CalemPmDependencyViewList']={
	CalemViewInfo: {
		id: 'CalemPmDependencyViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'pm_dependency', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
			  ...
			  CalemDataGridInfo: {
				listInfo: {
			  	   CalemListInfo: {
			  			noMaximize: true,
			  			colList: [
			  			   {CalemCol: {id: 'child_pm_id', width: 300}}
			  			]	 
			  		} 		
		      }
			}
