 ...
 * List views
 */
CalemViewDef['CalemRcmConsequenceViewList']={
	CalemViewInfo: {
		id: 'CalemRcmConsequenceViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'rcm_consequence', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
			  ...
			  CalemDataGridInfo: {
				listInfo: {
			  	   CalemListInfo: {
			  			noMaximize: true,
			  			colList: [
			  			   {CalemCol: {id: 'consequence', width: 300}}
			  			]	 
			  		} 		
		      }
			}
