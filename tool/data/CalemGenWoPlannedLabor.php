...
$_CALEM_gen_data = array(
	'title'=>' === Generating WoPlannedLabor ===' . "<br>",
   'regenerate'=>true,
   'overwrite'=>false,
   'dataList'=>array(
      array(
   		...
   		'file_dst'=>array(
   			...
   			'pattern'=>'CalemWoPlannedLaborForm')
   	),
   	array(
			'file_src'=>array(
   		...
   		'file_dst'=>array(
   			...
   			'pattern'=>'CalemWoPlannedLaborView')
   	)
   ),
   'file_patterns'=>array(
   	'CalemPmLabor'=>'CalemWoPlannedLabor',
   	'pm_labor' => 'wo_planned_labor'   
   )
);
