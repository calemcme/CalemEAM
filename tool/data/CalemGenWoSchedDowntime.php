...
$_CALEM_gen_data = array(
	'title'=>' === Generating WoSchedDowntime ===' . "<br>",
   'regenerate'=>true,
   'overwrite'=>false,
   'dataList'=>array(
      array(
   		...
   		'file_dst'=>array(
   			...
   			'pattern'=>'CalemWoSchedDowntimeForm')
   	),
   	array(
			'file_src'=>array(
   		...
   		'file_dst'=>array(
   			...
   			'pattern'=>'CalemWoSchedDowntimeView')
   	)
   ),
   'file_patterns'=>array(
   	'CalemPmLabor'=>'CalemWoSchedDowntime',
   	'pm_labor' => 'wo_sched_downtime',
   	'craft_id'=>'hours'   
   )
);
