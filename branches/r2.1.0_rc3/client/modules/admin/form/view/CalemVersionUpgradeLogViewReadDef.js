...
CalemViewDef['CalemVersionUpgradeLogViewRead']={
	CalemViewInfo: {
		id: 'CalemVersionUpgradeLogViewRead',
		type: 'CalemView',
		layout: {
		 CalemLayoutInfo: {
		...
		itemMap : {
			...
			toolbar: {
				CalemToolBarInfo: {
					type: 'CalemToolBar',
					layout: ['CalemTbEdit', 'CalemTbDelete', 'CalemTbPrev', 'CalemTbNext', 'sep', 'CalemTbCancel', 'sep2', 'CalemTbCustomize'],
					list: [
