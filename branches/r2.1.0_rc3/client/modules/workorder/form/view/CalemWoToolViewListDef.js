 ...
 * List views
 */
CalemViewDef['CalemWoToolViewList']={
	CalemViewInfo: {
		id: 'CalemWoToolViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'wo_tool', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
					layout: ['CalemTbOpen', 'CalemTbDelete', 'sep', 'sep2','CalemTbCustomize'],
					list: [
				   { CalemButtonInfo: {id: 'CalemTbWoToolNew'}},
