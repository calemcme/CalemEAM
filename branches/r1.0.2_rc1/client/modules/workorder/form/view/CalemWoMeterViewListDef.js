 ...
 * List views
 */
CalemViewDef['CalemWoMeterViewList']={
	CalemViewInfo: {
		id: 'CalemWoMeterViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'wo_meter', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
					...
					list: [
				   //New
					{ CalemButtonInfo: {id: 'CalemTbWoMeterNew'}},
					...
					{ CalemButtonInfo: {id: 'CalemTbWoMeterHistory'}},
			  ...
			  CalemDataGridInfo: {
				listInfo: {
			  	   CalemListInfo: {
			  			noMaximize: true,
			  			colList: [
			  			   {CalemCol: {id: 'meter_id', width: 300}}
			  			]	 
			  		} 		
		      }
			}
