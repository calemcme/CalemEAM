 ...
 * List views
 */
CalemViewDef['CalemInsCitationViewList']={
	CalemViewInfo: {
		id: 'CalemInsCitationViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			...
			toolbar: {
				CalemToolBarInfo: {
					layout: ['CalemTbNew', 'CalemTbOpen', 'CalemTbDelete', 'CalemTbDataRefresh', 'sep','CalemTbCustomize'],
					list: [
				   //New
			  ...
			  CalemDataGridInfo: {
				listInfo: {
			  	   CalemListInfo: {
			  			noMaximize: true,
			  			colList: [
			  			   {CalemCol: {id: 'citation', width: 200}}
			  			]	 
			  		} 		
		      }
			}
