 ...
 * List views
 */
CalemViewDef['CalemManufacturerViewList']={
	CalemViewInfo: {
		id: 'CalemManufacturerViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'manufacturer', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
					layout: ['CalemTbNew', 'CalemTbOpen', 'CalemTbDelete', 'sep', 'CalemTbSearch', 'CalemTbSearchClear', 'sep2', 'CalemTbCustomize'],
					list: [
				   //New
			  ...
			  CalemDataGridInfo: {
				listInfo: {
			  	   CalemListInfo: {
			  			noMaximize: true,
			  			colList: [
			  			   {CalemCol: {id: 'manufacturer', width: 150}},
			  			   {CalemCol: {id: 'note', width: 200}},
			  			   {CalemCol: {id: 'contact_id', width: 150}}
			  			]	 
			  		} 		
		      }
			}
