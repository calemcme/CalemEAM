 ...
 * List views
 */
CalemViewDef['CalemRcmFunctionViewList']={
	CalemViewInfo: {
		id: 'CalemRcmFunctionViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'rcm_function', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
