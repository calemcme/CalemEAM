 ...
 * List views
 */
CalemViewDef['CalemTrainingUserViewList']={
	CalemViewInfo: {
		id: 'CalemTrainingUserViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'training_user', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
