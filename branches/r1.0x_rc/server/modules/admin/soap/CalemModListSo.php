 ...
 */
class CalemModListSo extends CalemCustomHandler {
	...
	public function getFileName($viewObj) {
		return $viewObj->target . $this->getPattern();
	}
	
	public function getContent($viewObj) {
		return "CalemModListCustomDef['" . $viewObj->target . "']= " . base64_decode($viewObj->custom) . ";";
	}
