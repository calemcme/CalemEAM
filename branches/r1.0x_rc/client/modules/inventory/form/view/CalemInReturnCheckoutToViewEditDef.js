...
CalemViewDef['CalemInReturnCheckoutToViewEdit']={
	CalemViewInfo: {
		id: 'CalemInReturnCheckoutToViewEdit',
		type: 'CalemView',
		layout: {
		 CalemLayoutInfo: {
		...
		itemMap : {
			...
			'lb_caption': {
				CalemLabelInfo: {id: 'in_vt_return_checkout_to', className: 'CalemEditCaption'}
			},
			'err': {
				CalemFormErrorInfo: {id: 'form_error'}
			},
			'checkout_to' : {CalemEditInCheckoutToInfo: {field: 'checkout_to'}}
	}
 } //ItemMap	
}
};
