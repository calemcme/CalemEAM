 ...
 * List views
 */
CalemViewDef['CalemInReturnViewList']={
	CalemViewInfo: {
		id: 'CalemInReturnViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'in_tran_checkout', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
					layout: ['CalemTbInTranReturn', 'CalemTbCancel', 'sep','CalemTbDataRefresh', 'CalemTbCustomize'],
					list: [
