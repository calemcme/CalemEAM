 ...
 * List views
 */
CalemViewDef['CalemWoPlannedDowntimeViewList']={
	CalemViewInfo: {
		id: 'CalemWoPlannedDowntimeViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'wo_planned_downtime', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
