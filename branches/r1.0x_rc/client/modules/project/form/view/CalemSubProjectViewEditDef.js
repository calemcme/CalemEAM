 ...
 * Budget views
 */
CalemViewDef['CalemSubProjectViewEdit']={
	CalemViewInfo: {
		id: 'CalemSubProjectViewEdit',
		type: 'CalemView',
		layout: {
		 CalemLayoutInfo: {
		...
		itemMap : {
			...
			'lb_codes': {
				CalemLabelInfo: {id: 'sec_project_codes', className: 'CalemEditSection'}
			},
			'lb_cost': {
				CalemLabelInfo: {id: 'sec_project_cost', className: 'CalemEditSection'}
			}
	}
 } //ItemMap	
}
