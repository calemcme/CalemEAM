 ...
 * List views
 */
CalemViewDef['CalemPoItemViewList']={
	CalemViewInfo: {
		id: 'CalemPoItemViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'po_item', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
					layout: ['CalemTbPoAddItem', 'CalemTbOpen', 'CalemTbDelete', 'sep','CalemTbCustomize'],
					list: [
				   //New
					{CalemButtonInfo: {id: 'CalemTbPoAddItem'}},
