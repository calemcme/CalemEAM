...
/**
 * CalemInspectionFormList
 */
function CalemInspectionFormList(parent, formId, data) {
	if (arguments.length==0) return;
	CalemFormList.call(this, parent, formId, data);
}

CalemInspectionFormList.prototype = new CalemFormList;
CalemInspectionFormList.prototype.constructor = CalemInspectionFormList;

CalemInspectionFormList.prototype.toString = function() { return "CalemInspectionFormList";}

/**
 * Business APIs
 */
CalemInspectionFormList.prototype._getFormNewId =
function() {
    return 'CalemInspectionFormNew';
} 
 
CalemInspectionFormList.prototype._onOpen =
function(evt) {
	...
	this._openForm('CalemInspectionFormMdTab', data);
}  

/**
 * Deletion must be handled specially
 */
CalemInspectionFormList.prototype.onDelete =
function(evt) {
