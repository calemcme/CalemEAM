 ...
 * List views
 */
CalemViewDef['CalemBudgetStatusLogViewList']={
	CalemViewInfo: {
		id: 'CalemBudgetStatusLogViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'budget_status_log', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
			  ...
			  CalemDataGridInfo: {
				listInfo: {
			  	   CalemListInfo: {
			  			noMaximize: true,
			  			colList: [
			  			   {CalemCol: {id: 'to_state_id', width: 300}}
			  			]	 
			  		} 		
		      }
			}
