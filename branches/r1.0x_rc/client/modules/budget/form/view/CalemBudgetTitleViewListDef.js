 ...
 * Budget views
 */
CalemViewDef['CalemBudgetTitleViewList']={
	CalemViewInfo: {
		id: 'CalemBudgetTitleViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'budget_title', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
				...
				listInfo: {
			  	   CalemListInfo: {
			  			...
			  			colList: [
			  			   ...
			  			   {CalemCol: {id: 'modified_time', width: 160}}
			  			]	 
			  		} 		
		      }
			}
