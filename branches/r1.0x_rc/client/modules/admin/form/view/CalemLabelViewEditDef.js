 ...
 * User views
 */
CalemViewDef['CalemLabelViewEdit']={
	CalemViewInfo: {
		id: 'CalemLabelViewEdit',
		type: 'CalemView',
		layout: {
		 CalemLayoutInfo: {
			...
			rows: [
               ...
               {CalemTrInfo: {cols: ['flb_id', 'id']}},
               {CalemTrInfo: {cols: ['flb_label', 'label']}},
               {CalemTrInfo: {cols: ['flb_locale', 'locale']}}
				   ]
			}
		},
		itemMap : {
			...
			'lb_caption': {
				CalemLabelInfo: {id: 'vt_label', className: 'CalemEditCaption'}
			},
			'err': {
