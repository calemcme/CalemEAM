 ...
 */
function CalemDesignTreeModListRoot(parent) {
...
CalemDesignTreeModListRoot.prototype = new CalemDesignTreeFormRecord;
CalemDesignTreeModListRoot.prototype.constructor = CalemDesignTreeModListRoot;

CalemDesignTreeModListRoot.prototype.toString = 
function() {
	return "CalemDesignTreeModListRoot";
}

/**
 * Handling drop from view layout to the tree.
 */
CalemDesignTreeModListRoot.prototype._onDrop =
