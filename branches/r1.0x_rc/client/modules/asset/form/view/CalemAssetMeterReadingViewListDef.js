 ...
 * List views
 */
CalemViewDef['CalemAssetMeterReadingViewList']={
	CalemViewInfo: {
		id: 'CalemAssetMeterReadingViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'meter_transaction', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
					layout: ['CalemTbNew', 'CalemTbOpen', 'CalemTbDelete', 'sep', 'CalemTbMeterReadingHistory', 'CalemTbAddMeterReading', 'sep2', 'CalemTbCustomize'],
					list: [
				   //New
			  ...
			  CalemDataGridInfo: {
				listInfo: {
			  	   CalemListInfo: {
			  			noMaximize: true,
			  			colList: [
			  			   {CalemCol: {id: 'reading', width: 130}},
			  			   {CalemCol: {id: 'is_rollover', width: 120}},
			  			   {CalemCol: {id: 'time_taken', width: 130}},
