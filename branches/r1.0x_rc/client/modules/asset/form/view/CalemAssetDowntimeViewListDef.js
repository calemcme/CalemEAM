 ...
 * List views
 */
CalemViewDef['CalemAssetDowntimeViewList']={
	CalemViewInfo: {
		id: 'CalemAssetDowntimeViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'asset_downtime', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
			  ...
			  CalemDataGridInfo: {
				listInfo: {
			  	   CalemListInfo: {
			  			noMaximize: true,
			  			colList: [
			  			   {CalemCol: {id: 'start_time', width: 130}},
			  			   {CalemCol: {id: 'end_time', width: 130}},
			  			   {CalemCol: {id: 'hours', width: 130}},
