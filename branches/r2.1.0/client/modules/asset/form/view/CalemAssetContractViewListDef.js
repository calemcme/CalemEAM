 ...
 * List views
 */
CalemViewDef['CalemAssetContractViewList']={
	CalemViewInfo: {
		id: 'CalemAssetContractViewList',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'asset_contract', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
			  ...
			  CalemDataGridInfo: {
				listInfo: {
			  	   CalemListInfo: {
			  			noMaximize: true,
			  			colList: [
			  			   {CalemCol: {id: 'contract_id', width: 300}}
			  			]	 
			  		} 		
		      }
			}
