 ...
 * Lookup views
 */
CalemViewDef['CalemPoItemRemoveViewLookup']={
	CalemViewInfo: {
		id: 'CalemPoItemRemoveViewLookup',
		type: 'CalemView',
		layout: {
			CalemLayoutInfo: {
		...
		itemMap : {
			CalemItemMap: {
			'lb_caption': {
				CalemLabelInfo: {id: 'req_item', className: 'CalemEditCaption'}
			},
			toolbar: {
				CalemToolBarInfo: {
