...
CalemViewDef['CalemDashWoOrigMdViewChart']={
	CalemViewInfo: {
		id: 'CalemDashWoOrigMdViewChart',
		type: 'CalemView',
		layout: {
		 CalemLayoutInfo: {
		...
		itemMap : {
			...
			'lb_caption': {
				CalemLabelInfo: {id: 'dash_wo_orig_md', className: 'CalemEditCaption'}
			},
			'chart_info': {
				CalemChartLineInfo: {id: 'dash_wo_orig_md'}
			}
	}
 } //ItemMap	
}
