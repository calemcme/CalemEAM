 ...
 * CalemPmFormList
 */
function CalemPmFormList(parent, formId, data) {
	if (arguments.length==0) return;
	CalemFormList.call(this, parent, formId, data);
}

CalemPmFormList.prototype = new CalemFormList;
CalemPmFormList.prototype.constructor = CalemPmFormList;

CalemPmFormList.prototype.toString = function() { return "CalemPmFormList";}

/**
 * Business APIs
 */
CalemPmFormList.prototype._getFormNewId =
function(evt) {
 ...
 */
CalemPmFormList.prototype._onOpen =
function(evt) {
	...
	this._openForm('CalemPmFormMdTab', data);
} 

/**
 * Deletion must be handled specially
 */
CalemPmFormList.prototype.onDelete =
function(evt) {
