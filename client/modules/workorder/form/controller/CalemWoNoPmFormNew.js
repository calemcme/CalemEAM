 ...
 * CalemWoNoPmFormNew
 */
function CalemWoNoPmFormNew(parent, formId, data) {
	if (arguments.length==0) return;
	CalemFormNewCacheLoad.call(this, parent, formId, data);
}

CalemWoNoPmFormNew.prototype = new CalemFormNewCacheLoad;
CalemWoNoPmFormNew.prototype.constructor = CalemWoNoPmFormNew;
